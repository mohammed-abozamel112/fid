        ...
        <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    ...
                    <p
                        class="max-w-md mx-auto mt-6 leading-relaxed text-center text-[#A31621] sm:max-w-xs sm:mx-0 sm:text-left">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
                    ...
                    <div class="text-center sm:text-left">
                        <p class="text-lg font-medium text-[#A31621]">{{app()->getLocale()==='en'?'Contact Us' :'تواصل معنا'}}</p>
                        ...
                        <ul class="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a class="flex items-center justify-center sm:justify-start gap-1.5 group"
                                    ...
                                    <span
                                        class="text-[#A31621] transition group-hover:text-[#A31621]/75">
                                        +966530030468
                                    </span>
                                </a>
                            </li>
