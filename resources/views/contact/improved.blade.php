        ...
        <section class="relative py-20 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto {{ $textAlignCenter }}">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5 {{ $marginRight }}">
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid lg:grid-cols-2 gap-16">
                            ...
                            <div class="p-6 pt-0">
                                <form action="{{ route('contact.submit', ['lang' => app()->getLocale()]) }}" method="POST" class="space-y-6">
                                    ...
                                    <div class="grid md:grid-cols-2 gap-6">
                                        <div>
                                            <label class="block text-sm font-semibold mb-2 {{ $textAlign }}" style="color: #A31621;">
                                            ...
                                            />
                                            @error('name')
                                                <p class="text-red-500 text-sm mt-1 {{ $textAlign }}">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div>
                                            <label class="block text-sm font-semibold mb-2 {{ $textAlign }}" style="color: #A31621;">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            required
                                            rows="6"
                                            class="border-2 focus:border-red-300 transition-colors resize-none w-full px-3 py-2 border-gray-300 rounded-md {{ $textAlign }}"
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="space-y-6">
                            <div class="p-6 {{ $borderLeft }} transition-all duration-300 hover:shadow-lg hover:scale-[1.02] bg-white rounded-lg shadow" style="border-left-color: #A31621;">
                                <div class="flex items-center space-x-4 {{ $flexReverse }}">
                                    ...
                                    <div class="{{ $textAlign }}">
                                        <h3 class="font-semibold text-lg" style="color: #A31621;">{{ $isRtl ? 'راسلنا عبر البريد الإلكتروني' : 'Email Us' }}</h3>
                            ...
                            <div class="p-6 {{ $borderLeft }} transition-all duration-300 hover:shadow-lg hover:scale-[1.02] bg-white rounded-lg shadow" style="border-left-color: #A31621;">
                                <div class="flex items-center space-x-4 {{ $flexReverse }}">
                                    ...
                                    <div class="{{ $textAlign }}">
                                        <h3 class="font-semibold text-lg" style="color: #A31621;">{{ $isRtl ? 'اتصل بنا' : 'Call Us' }}</h3>
                            ...
                            <div class="p-6 {{ $borderLeft }} transition-all duration-300 hover:shadow-lg hover:scale-[1.02] bg-white rounded-lg shadow" style="border-left-color: #A31621;">
                                <div class="flex items-center space-x-4 {{ $flexReverse }}">
                                    ...
                                    <div class="{{ $textAlign }}">
                                        <h3 class="font-semibold text-lg" style="color: #A31621;">{{ $isRtl ? 'زورنا' : 'Visit Us' }}</h3>
                                        <p class="text-gray-600">{{ $isRtl ? '123 شارع التكنولوجيا، مدينة الابتكار، كاليفورنيا 90210' : '123 Tech Street, Innovation City, CA 90210' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-8">
                            ...
                            <div class="flex {{ $isRtl ? 'justify-end' : 'justify-start' }} space-x-4 {{ $spaceReverse }}">
