    ...
    <article class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <header class="mb-8">
            ...
            <div class="flex items-center text-sm text-gray-600 mb-4">
                ...
                <span class="bg-{{ $blog->status === 'published' ? 'green' : 'yellow' }}-100 text-{{ $blog->status === 'published' ? 'green' : 'yellow' }}-800 px-2 py-1 rounded-full text-xs">
                    {{ ucfirst($blog->status) }}
                </span>
            </div>
        ...
        <section class="mt-8 pt-8 border-t border-gray-200">
            ...
            <div class="flex space-x-4">
                <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($blog->title) }}" 
                   class="bg-blue-400 hover:bg-blue-500 text-white px-4 py-2 rounded transition-colors"
                ...
                <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(request()->url()) }}" 
                   class="bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 rounded transition-colors"
                   target="_blank" rel="noopener">
                    LinkedIn
                </a>
            </div>
